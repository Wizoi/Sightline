...
[docs/personas/04-audio-dsp-engineer.md](../../docs/personas/04-audio-dsp-engineer.md) for the full write-up. Read that file
first.
...
Any new finding should be written back into docs/personas/04-audio-dsp-engineer.md.
