...
import { runWinkTest, runWinkCalibration, resetWinkCalibration, retryWinkFlow, beginWinkTestSequence } from './winkTest.js';
...
$('winkResetBtn').onclick = resetWinkCalibration;
$('winkTestStart').onclick = beginWinkTestSequence;
$('winkTestRetry').onclick = () => { $('winkTestRes').style.display = 'none'; retryWinkFlow(); };
